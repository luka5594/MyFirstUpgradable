...
contract VendingMachineV2 is Initializable {
  ...
  mapping(address => uint)sodaPurchased;
  ...
  function addSoda(uint sodas) public onlyOwner{
    require(sodas > 0, "Can't add 0 sodas");
    numSodas += sodas;
  } 

  function purchaseSoda() public payable {
    require(msg.value >= 1000 wei, "You must pay 1000 wei for a soda!");
    require(numSodas > 0, "There isn't enough sodas");
    numSodas--;
    sodaPurchased[msg.sender]++; 
